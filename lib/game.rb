...
class Game
  ...
  def play_game
    ...
    until computer_loss || player_loss
      ...
      # player_ships_sunk = @player_board.cells.all? {|cell| cell.ship.health <= 0 || nil}
  ...
  def player_create_ships
    ...
    puts " "
    puts "Aircraft Carriers: Enterprise, Midway, Ranger, Nimitz"
    puts "Battleships: Texas, Kearsarge, Iowa, Arizona, Missouri, Yamato, Bismark"
    puts "Submarines: Tang, Thresher, Silversides, Flasher, Seahorse, Ohio"
    puts "Cruisers & Destroyers: Ticonderoga, Fitzgerald, John McCain, Cole, Kidd"
    puts " "
    if @player_ships != []
    puts "Current Ships:"
